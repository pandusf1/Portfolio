    ...
    <section className="relative bg-slate-50 pt-32 -mt-24 pb-20 lg:pt-48 lg:pb-10 overflow-hidden">
      <div className="container mx-auto px-6 pt-4">
        <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex gap-6 mt-2 border-t border-slate-200/60 py-4">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <span className="text-xs text-slate-500">Python & Odoo Dev</span>
                    </div>
                </div>
                <div className="flex items-start gap-3">
          ...
          {/* --- KOLOM KANAN: VISUAL (CODE + ACCOUNTING) --- */}
          <div className="w-full lg:w-1/2 relative flex justify-center py-10 lg:py-0">
            ...
            <div className="relative w-full max-w-md aspect-square flex items-center justify-center">
              ...
              {/* 3. PENGHUBUNG (Visual Connection) */}
              {/* Garis lengkung menghubungkan Code ke Invoice */}
